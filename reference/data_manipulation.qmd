...
| Name | Description |
| --- | --- |
| [board](#arrow_wrangler.data_manipulation.ArrowWrangler.board) | Get board. |
| [dataframe](#arrow_wrangler.data_manipulation.ArrowWrangler.dataframe) | Get dataframe. |
...
|----------------|--------------|--------------------------------------------------------------------------------------------------------------------|------------|
| func           | callable     | Function to apply. Must have input pa.Table and return pa.Table.                                                   | _required_ |
| *args          | tuple        | Arguments that will be passed to the function.                                                                     | `()`       |
| other_datasets | list \| None | List of strings defining the names of data pins to read. The string names must match the function parameter names. | `None`     |
...
|--------|---------------|---------------------------------------------------------|
|        | ArrowWrangler | ArrowWrangler instance with updated dataframe property. |
...
| input_tbl_name | str          | Name to get table alias eg so you can use SELECT * FROM me. Defaults to 'me'.                                                                              | `'me'`     |
...
| Name   | Type                  | Description                                                                                    |
|--------|-----------------------|------------------------------------------------------------------------------------------------|
|        | ArrowWrangler \| None | ArrowWrangler \| None: ArrowWrangler instance with loaded dataframe, or None if pin not found. |
...
| Name             | Type                    | Description                                                                                                      | Default    |
|------------------|-------------------------|------------------------------------------------------------------------------------------------------------------|------------|
| hostname         | str                     | String for connecting to mssql.                                                                                  | _required_ |
| database         | str                     | Database.schema.table string.                                                                                    | _required_ |
| filter_condition | str \| Callable \| None | Either an sql filter condition or function to filter/manipulate using sql before saving arrow. Defaults to None. | `None`     |

###### Returns {.doc-section .doc-section-returns}

| Name          | Type          | Description                              |
|---------------|---------------|------------------------------------------|
| ArrowWrangler | ArrowWrangler | ArrowWrangler instance with loaded data. |
...
| Name   | Type   | Description                                             |
|--------|--------|---------------------------------------------------------|
|        | None   | ArrowWrangler instance with updated dataframe property. |
...
| sheet  | str    | Name of the Excel sheet.         | _required_ |
