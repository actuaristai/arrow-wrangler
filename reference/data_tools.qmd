...
|--------|--------|-----------------------------------------------------------------------|
| Table  | Table  | Ibis Table with columns: level, count, percent, cum_perc, and column. |
...
| Name   | Type   | Description                        |
|--------|--------|------------------------------------|
| Table  | Table  | Ibis Table object of parquet file. |
...
| Name   | Type     | Description           | Default    |
|--------|----------|-----------------------|------------|
| f      | Callable | Function to decorate. | _required_ |

###### Returns {.doc-section .doc-section-returns}

| Name     | Type     | Description                                              |
|----------|----------|----------------------------------------------------------|
| Callable | Callable | Wrapped function that logs timing and shape information. |